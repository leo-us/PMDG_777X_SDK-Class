...
namespace PMDG_777X_SDK_ns
{
    public class PMDG_777X_SDK_class
    {
        ...
        {
            //Marshalling of PMDG_777X_Data.h to managed code:
            //-----------------------------------------------
            // Structure: [StructLayout(LayoutKind.Sequential, Pack = 4, CharSet = CharSet.Ansi)]
            // Non-blittable types:
                // bool -> public byte
                // bool (n-array) -> [MarshalAs(UnmanagedType.ByValArray, SizeConst = n)] public byte[]
                // char -> public byte
                // char (n-array) -> [MarshalAs(UnmanagedType.ByValArray, SizeConst = n)] public byte[]
                // unsigned char -> public byte
                // unsigned char (n-array) -> [MarshalAs(UnmanagedType.ByValArray, SizeConst = n)] public byte[]
                //int -> public int
                //unsigned int -> public uint
                // float -> public float
                // float (n-array) -> [MarshalAs(UnmanagedType.ByValArray, SizeConst = n)] public float[]
                // short -> public short
                // short (n-array) -> [MarshalAs(UnmanagedType.ByValArray, SizeConst = n)] public short[]
                // unsigned short -> public ushort
                // unsigned short (n-array) -> [MarshalAs(UnmanagedType.ByValArray, SizeConst = n)] public ushort[]
            ...
            // Backup Window Heat
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ICE_WindowHeatBackUp_Sw_OFF;

            // Standby Power
            public byte ELEC_StandbyPowerSw;              // 0: OFF  1: AUTO  2: BAT

            // Flight Controls		
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public byte[] FCTL_WingHydValve_Sw_SHUT_OFF;  // left/right/center	
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public byte[] FCTL_TailHydValve_Sw_SHUT_OFF;  // left/right/center	
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public byte[] FCTL_annunTailHydVALVE_CLOSED;  // left/right/center	
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public byte[] FCTL_annunWingHydVALVE_CLOSED;  // left/right/center	
            ...
            // EEC MAINT
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ENG_EECPower_Sw_TEST;
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] IRS_ModeSelectorAIR_CargoTemp_Selector;            // aft / bulk  0=OFF  1=LOW  2=HIGH   AFT/BULK
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ELEC_BusTie_Sw_AUTO;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ELEC_annunBusTieISLN;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ELEC_ExtPwrSw;                  // primary/secondary - MOMENTARY SWITCHES
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ELEC_annunExtPowr_ON;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ELEC_annunExtPowr_AVAIL;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ELEC_Gen_Sw_ON;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ELEC_annunGenOFF;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ELEC_BackupGen_Sw_ON;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ELEC_annunBackupGenOFF;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ELEC_IDGDiscSw;                 // MOMENTARY SWITCHES
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ELEC_annunIDGDiscDRIVE;
            ...
            // Window Heat
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public byte[] ICE_WindowHeat_Sw_ON;           // L-Side/L-Fwd/R-Fwd/R-Side
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public byte[] ICE_annunWindowHeatINOP;            // L-Side/L-Fwd/R-Fwd/R-Side

            // Hydraulics
            public byte HYD_RamAirTurbineSw;
            public byte HYD_annunRamAirTurbinePRESS;
            public byte HYD_annunRamAirTurbineUNLKD;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] HYD_PrimaryEngPump_Sw_ON;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] HYD_PrimaryElecPump_Sw_ON;
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] HYD_annunPrimaryEngPumpFAULT;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] HYD_annunPrimaryElecPumpFAULT;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] HYD_annunDemandElecPumpFAULT;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] HYD_annunDemandAirPumpFAULT;
            ...
            // Exterior Lights
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public byte[] LTS_LandingLights_Sw_ON;            // Left/Right/Nose 
            public byte LTS_Beacon_Sw_ON;
            public byte LTS_NAV_Sw_ON;
            public byte LTS_Logo_Sw_ON;
            public byte LTS_Wing_Sw_ON;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] LTS_RunwayTurnoff_Sw_ON;
            public byte LTS_Taxi_Sw_ON;
            public byte LTS_Strobe_Sw_ON;

            // Engine, APU and Cargo Fire
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FIRE_CargoFire_Sw_Arm;          // FWD/AFT
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FIRE_annunCargoFire;                // FWD/AFT
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FIRE_EngineHandleIlluminated;
            public byte FIRE_APUHandleIlluminated;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FIRE_EngineHandleIsUnlocked;
            ...
            // Engine
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ENG_EECMode_Sw_NORM;                // left / right
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FUEL_PumpFwd_Sw;                    // left fwd / right fwd
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FUEL_PumpAft_Sw;                    // left aft / right aft
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FUEL_PumpCtr_Sw;                    // ctr left / ctr right
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FUEL_JettisonNozle_Sw;          // left / right
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FUEL_annunLOWPRESS_Fwd;         // left fwd / right fwd
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FUEL_annunLOWPRESS_Aft;         // left aft / right aft
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FUEL_annunLOWPRESS_Ctr;         // ctr left / ctr right
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FUEL_annunJettisonNozleVALVE;   // left / right
            ...
            // Air Conditioning
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] AIR_Pack_Sw_AUTO;               // left / right
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] AIR_TrimAir_Sw_On;              // left / right
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] AIR_RecircFan_Sw_On;                // upper / lower	
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] AIR_annunPackOFF;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] AIR_annunTrimAirFAULT;
            ...
            // Bleed Air
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] AIR_EngBleedAir_Sw_AUTO;            // left engine / right engine
            public byte AIR_APUBleedAir_Sw_AUTO;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] AIR_IsolationValve_Sw;          // left / right 
            public byte AIR_CtrIsolationValve_Sw;          // left / right 
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] AIR_annunEngBleedAirOFF;               // left engine / right engine
            public byte AIR_annunAPUBleedAirOFF;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] AIR_annunIsolationValveCLOSED;  // left / right 
            public byte AIR_annunCtrIsolationValveCLOSED;

            // Pressurization
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] AIR_OutflowValve_Sw_AUTO;       // fwd / aft
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] AIR_annunOutflowValve_MAN;      // fwd / aft
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] CHR_Chr_Sw_Pushed;              // MOMENTARY SWITCH
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] CHR_TimeDate_Sw_Pushed;         // MOMENTARY SWITCH
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] EFIS_MinsRST_Sw_Pushed;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] EFIS_BaroSTD_Sw_Pushed;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] EFIS_ModeCTR_Sw_Pushed;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] EFIS_RangeTFC_Sw_Pushed;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] EFIS_WXR_Sw_Pushed;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] EFIS_STA_Sw_Pushed;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] EFIS_WPT_Sw_Pushed;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] EFIS_ARPT_Sw_Pushed;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] EFIS_DATA_Sw_Pushed;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] EFIS_POS_Sw_Pushed;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] EFIS_TERR_Sw_Pushed;
            ...
            // MCP - Switches
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] MCP_FD_Sw_On;                   // left / right
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] MCP_ATArm_Sw_On;                    // left / right
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] MCP_AP_Sw_Pushed;               // left / right
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] MCP_annunAP;                        // left / right
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] WARN_Reset_Sw_Pushed;           // MOMENTARY action
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public byte[] CDU_annunEXEC;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public byte[] CDU_annunDSPY;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public byte[] CDU_annunFAIL;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public byte[] CDU_annunMSG;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public byte[] CDU_annunOFST;
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] ENG_FuelControl_Sw_RUN;
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public byte[] COMM_RadioTransfer_Sw_Pushed;   // MOMENTARY action
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public byte[] COMM_RadioPanelOff;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public byte[] COMM_annunAM;
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FIRE_EngineHandleUnlock_Sw;     // ENG 1/ENG2   MOMENTARY SWITCH resets when handle pulled
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] FIRE_annunENG_BTL_DISCH;            // ENG 1/ENG2
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] EFIS_BaroMinimumsSet;           // left/right control panel. Note: check EFIS_MinsSelBARO[2] to determine if the active minimums is BARO or RADIO
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public int[] EFIS_BaroMinimums;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public byte[] EFIS_RadioMinimumsSet;
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public byte[] ECL_ChecklistComplete;
        ...
        public struct PMDG_777X_CDU_Screen
        {
            ...
            public struct CDUROWS
            {
                ...
                public PMDG_777X_CDU_Cell[] cduRows;
            }
            public byte Powered;  
        ...
        public const UInt32 ACP_SEL_RECV_VHFR = 0x0004;
        public const UInt32 ACP_SEL_RECV_FLT = 0x0008;
        public const UInt32 ACP_SEL_RECV_CAB = 0x0010;
        public const UInt32 ACP_SEL_RECV_PA = 0x0020;
        public const UInt32 ACP_SEL_RECV_HFL = 0x0040;
        public const UInt32 ACP_SEL_RECV_HFR = 0x0080;
        public const UInt32 ACP_SEL_RECV_SAT1 = 0x0100;
        public const UInt32 ACP_SEL_RECV_SAT2 = 0x0200;
        public const UInt32 ACP_SEL_RECV_SPKR = 0x0400;
        public const UInt32 ACP_SEL_RECV_VOR_ADF = 0x0800;
        public const UInt32 ACP_SEL_RECV_APP = 0x1000;
    ...
    }//End of class 'PMDG_777X_SDK_class'
}//End of namespace 'PMDG_777X_SDK_ns'
